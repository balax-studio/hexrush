...
class _TopBarHUDState extends ConsumerState<TopBarHUD> {
  ...
  void _showResourceExplanation(
    ...
    if (resourceKey != null) {
      final activeDocIds = gameState.activeDoctrineSlots.values
          .whereType<String>()
          .toSet();
      final activeDoctrines = gameState.doctrines
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (breakdown.producers.isEmpty &&
                              breakdown.consumers.isEmpty)
                            Padding(
  ...
  Widget build(BuildContext context) {
    ...
    final bool canUpgradeCastle = EconomyCalculator.canAffordCastleUpgrade(
      resources,
      nextCastleLvl,
    );
    ...
    return RepaintBoundary(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: theme.surface,
          border: Border(bottom: BorderSide(color: theme.border, width: 2.5)),
          boxShadow: [
            BoxShadow(
                ...
                children: [
                  ResourcePulseChip(
                    ...
                    onTap: () => _showResourceExplanation(
                      ...
                      description:
                          'Kağanlığın temel besin kaynağı. Yeni altıgen toprakları fethetmek ve oba halkını doyurmak için harcanır.',
                      strategicHint:
                          'Tarlalar, Bozkır Göçer İaşesi doktrini ve Kağan Otağı\'ndan toplanır.',
                      theme: theme,
                    ),
                  ),
                  const SizedBox(width: 6),
                  ResourcePulseChip(
                    ...
                    onTap: () => _showResourceExplanation(
                      ...
                      description:
                          'İnşaat, atölye üretimi ve kış aylarında donan karoları ısıtmanın ana yakıtı.',
                      strategicHint:
                          'Oduncu kulübelerinden toplanır. Kalas ve mobilya üretimi için harcanır.',
                      theme: theme,
                    ),
                  ),
                  const SizedBox(width: 6),
                  ...
                  _buildLandChip(
                    ...
                    onTap: () => _showResourceExplanation(
                      ...
                      currentStock:
                          '${gameState.progression.ownedCount} Altıgen',
                      description:
                          'Egemenliğiniz altındaki karoların sayısı. Toprak sayısı arttıkça yeni yapay sinerjiler ve kaynaklar açılır.',
                      strategicHint:
                          'Bitişik karolara tıklayıp Gıda harcayarak yeni topraklar fethedin.',
                      theme: theme,
                    ),
                  ),
                  ...
                  children: [
                    ...
                    ResourcePulseChip(
                      ...
                      onTap: () => _showResourceExplanation(
                        ...
                        currentStock: NumberFormatter.format(
                          resources.furniture,
                        ),
                        netRate: NumberFormatter.formatRate(
                          netRates.furniture,
                    ...
                    ResourcePulseChip(
                      ...
                      onTap: () => _showResourceExplanation(
                        ...
                        currentStock: NumberFormatter.format(
                          resources.damascusSteel,
                        ),
                        netRate: NumberFormatter.formatRate(
                          netRates.damascusSteel,
                          decimals: 1,
                          unitSuffix: '/saniye',
                        ),
                        description:
              ...
              child: Container(
                ...
                child: Align(
                  ...
                  child: FractionallySizedBox(
                    widthFactor: (gameState.season.timer / 300.0).clamp(
                      0.0,
                      1.0,
                    ),
                    child: Container(color: _getSeasonColor(gameState.season)),
                  ),
                ),
              ),
            ),
...
class _ResourcePulseChipState extends State<ResourcePulseChip>
  ...
  void didUpdateWidget(covariant ResourcePulseChip oldWidget) {
    ...
    if ((widget.value - oldWidget.value).abs() >= 10.0) {
      ...
      _colorAnimation = ColorTween(
        begin: increased
            ? (widget.theme?.primaryGold.withValues(alpha: 0.45) ??
  ...
  Widget build(BuildContext context) {
    ...
    final bool hasUntransported =
        widget.untransportedRate != null && widget.untransportedRate! >= 0.01;
    final theme = widget.theme ?? NeoBrutalistTheme.basaltTheme;

    final String valStr = widget.isInt
    ...
    return RepaintBoundary(
      child: Semantics(
        ...
        label: '${widget.type.name.toUpperCase()}: $valStr$rateStr',
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: _controller.isAnimating
                      ? (_colorAnimation.value ?? theme.surfaceLight)
                      : theme.surfaceLight,
                  borderRadius: NeoBrutalistTheme.sharpRadius,
                  border: Border.all(
                    color: _controller.isAnimating
