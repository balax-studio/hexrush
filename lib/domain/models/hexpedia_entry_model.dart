  ...
  static List<HexpediaEntry> getAllEntries() {
    return [
      ...
      const HexpediaEntry(
        id: 'core_conquest',
        category: HexpediaCategory.core,
        titleTr: 'Karo Keşfi & Fetih (Sis Açma & Üssel Maliyet)',
        titleEn: 'Hex Conquest & Exponential Scaling',
        summaryTr: 'Komşu karolara yayılarak sınırları genişletin. Fetih maliyeti 1.6 kat üssel çarpanla artar.',
        summaryEn: 'Expand territory by conquering adjacent tiles. Cost scales exponentially at 1.6^N with total owned tiles.',
        contentTr: 'Haritada sahip olunan arazilerin sınır komşuları "Keşfedildi" (Discovered) durumuna geçer ve sis dağılır. Fethettiğiniz her yeni karo için gereken Gıda maliyeti 1.6 kat geometrik olarak artar (Maliyet = Taban * 1.6^karo * BiyomYoğunluğu * (1 - İndirim)).\n\nBu üssel artış nedeniyle 20-25 karodan sonra yeni toprak fethetmek milyonlarca gıdaya mal olur. Burası bir tıkanma noktası değil, Büyük Göç (Prestij) yaparak Atalar Tamgası kazanma ve yeni diyara daha güçlü göç etme zamanıdır.',
        contentEn: 'Adjacent hexes become discovered. Conquering tiles costs Food, scaling exponentially at 1.6^N with each conquered tile. Beyond 20-25 tiles, costs rise into millions, signaling the time to trigger a Great Migration for Tamga multipliers.',
        icon: Icons.explore,
        iconColor: Color(0xFF38BDF8),
        badgeText: 'FETİH & SİS',
        stats: {
          'Gereksinim': 'Komşu karo fethi',
          'Maliyet Formülü': '15 * 1.6^KaroSayısı (Üssel Artış)',
          'Gözcü Bonusu': 'Gözcü kulesi +2 sis menzili açar',
          'Töre İndirimi': 'Bozkır Akıncısı fermanı ile -%20 indirim',
        },
        stepGuideTr: [
        ...
        tipsTr: [
          ...
          'Töre Meclisinde "Bozkır Akıncısı" doktrinini takarak fetih maliyetinde %20 indirim kazanın.',
          'Fetih maliyeti 20.000 gıdayı aştığında haritada oyalanmayın; Büyük Göç ile Kut çarpanınızı katlayın.',
        ],
        tipsEn: [
          'Conquer forest and water edges first for strong early resource yields.',
          'Equip Steppe Raider doctrine in the Tore Council to discount conquest cost by 20%.',
          'When conquest cost exceeds 20,000 food, initiate a Great Migration instead of grinding.',
        ],
        tags: ['fetih', 'sis', 'harita', 'karo', 'conquest', 'fog', 'explore'],
      ),

      const HexpediaEntry(
        id: 'core_celestial_age',
        category: HexpediaCategory.core,
        titleTr: 'Göksel Çağ & Kozmik Zirve (Seviye 50)',
        titleEn: 'Celestial Era & Cosmic Peak (Level 50)',
        summaryTr: 'Şato Seviye 50\'de açılan 3 Efsanevi Kozmik Yapı ve nihai zafer anıtları.',
        summaryEn: '3 Legendary Cosmic structures unlocked at Castle Level 50 and ultimate victory monuments.',
        contentTr: 'Kağan Otağını Seviye 50\'ye ulaştırdığınızda kağanlık Göksel Çağa (Celestial Era) adım atar. Bu nihai çağda evrenin sırlarını çözen 3 efsanevi yapı inşa edilebilir hale gelir:\n\n1. Göksel Örs (Celestial Anvil - Sv. 50):\nGöksel Krater ve Volkan aurasıyla beslenir. Saniyede Göksel Cevher döker ve doğrudan kalıcı Atalar Tamgası üretir.\n\n2. Atalar Totemi (Ancestral Totem - Sv. 50):\nHaritadaki tüm Ata Kurganı anıtlarıyla rezonansa girer. Tüm kağanlık binalarına 3 katına (3.0x) varan küresel kutsama aurası yayar.\n\n3. Prizmatik Rezonatör (Prismatic Resonator - Sv. 50):\nKristal Yarığın prizmatik ışığını gökyüzüne yansıtır; Toy Coşkusu (10x) süresini 2 katına çıkarır ve gece akınlarında savunma kulelerine ilahi şimşek hasarı kazandırır.\n\nKozmik Zirveye Ulaşma Şartı:\nBu binaların maliyeti milyarlarca gıda ve oduna dayanır. Bu seviyeye ancak 5 planlı Büyük Göç yaparak toplam 100+ Tamga ve 11.0x Mega Kut çarpanına ulaşan usta kağanlar erişebilir.',
        contentEn: 'Reaching Castle Level 50 enters the Celestial Era, unlocking 3 legendary cosmic buildings: Celestial Anvil (forges Tamga tokens), Ancestral Totem (3x realm-wide kurgan resonance), and Prismatic Resonator (doubles 10x Toy Frenzy durations and empowers towers with lightning). Attainable only via 100+ Tamga prestige multipliers.',
        icon: Icons.auto_awesome,
        iconColor: Color(0xFFF59E0B),
        badgeText: 'KOZMİK ZİRVE',
        stats: {
          'Açılış Seviyesi': 'Kağan Otağı Seviye 50',
          'Kozmik Yapılar': 'Göksel Örs, Atalar Totemi, Prizmatik Rezonatör',
          'Gereken Prestij': '100+ Atalar Tamgası (11.0x Kut Çarpanı)',
          'Nihai Hedef': 'Kozmik Hükümdarlık & Tam Tamamlama',
        },
        stepGuideTr: [
          '5 Büyük Göç takvimini uygulayarak toplam Tamga sayınızı 100 barajının üzerine çıkarın.',
          'Kağan Otağını Seviye 50\'ye yükselterek altın göksel kubbeyi inşa edin.',
          'Göksel Krater veya Kristal biyomuna dokunup KOZMİK YAPILARI inşa edin.',
        ],
        stepGuideEn: [
          'Execute the 5-migration schedule to surpass 100 total Tamgas.',
          'Upgrade the Castle to Level 50 to unlock the Golden Celestial Dome.',
          'Tap Celestial Crater or Crystal hexes to erect the Cosmic Wonders.',
        ],
        tipsTr: [
          'Göksel binalar inşa edildiğinde oyunun tüm kültürel, askeri ve ekonomik başarımları eksiksiz tamamlanır.',
          'Diorama Merceğine geçerek göksel sarayınızın minyatür tilt-shift fotoğrafını çekip anıtlaştırın.',
        ],
        tipsEn: [
          'Constructing cosmic wonders fulfills all cultural, military, and economic triumphs.',
          'Switch to Diorama Lens to capture a commemorative sealed photograph of your celestial empire.',
        ],
        tags: ['göksel', 'kozmik', 'zirve', 'şato50', 'örs', 'totem', 'rezonatör', 'celestial', 'cosmic'],
      ),
      ...
      const HexpediaEntry(
        ...
        summaryTr: '4 Hex yarıçapındaki tarlaları ve madenleri otomatik toplayıp merkeze taşıyan işçiler çıkarır. (Gıda depolayamaz)',
        summaryEn: 'Spawns logistical workers that patrol a 4-hex radius, collecting yields automatically. (Cannot store food)',
        contentTr: 'İşçi Kulübesi, hammadde, ahşap, taş ve maden lojistiğini otomatikleştirir. Çevresindeki üretim binalarından sanayi malzemelerini toplar. ÖNEMLİ: İşçi kulübeleri gıda depolayamaz; gıda ürünleri tarlalardan ve fırınlardan sadece Gıda Ambarı veya Kağan Otağı tarafından depolanıp taşınır.',
        contentEn: 'Automates raw material, timber, stone, and ore gathering in a 4-hex radius. IMPORTANT: Worker Huts cannot store food; food products are stored and hauled exclusively via Food Storehouses or the Khan\'s Yurt.',
      ...
      const HexpediaEntry(
        ...
        category: HexpediaCategory.buildings,
        titleTr: 'Gıda Ambarı (Lojistik & Gıda Deposu)',
        titleEn: 'Food Storehouse (Logistics & Food Storage)',
        summaryTr: 'Gıda depolama kapasitesi ve 10x taşıma hacmi sağlar. İşçi kulübeleri gıda depolayamadığı için gıda ürünlerini depolar ve taşır.',
        summaryEn: 'Massive food storage and 10x hauling volume. Stores and transports food supplies since Worker Huts cannot store food.',
        contentTr: 'Gıda Ambarı, saf gıda lojistiği ve depolama yapısıdır. Tarlalar, otlaklar, fırınlar ve balıkçılardan elde edilen gıda ürünleri yalnızca Gıda Ambarı ve Şato tarafından depolanıp taşınabilir. İşçi kulübeleri hammadde, ahşap, taş ve madenleri taşır fakat gıda depolayamaz.',
        contentEn: 'The Food Storehouse is a specialized food logistics and storage hub. Food products gathered from farms, pastures, bakeries, and fisheries can only be stored and hauled via Food Storehouses and the Castle. Worker Huts haul raw materials, timber, stone, and ores, but cannot store food.',
      ...
      const HexpediaEntry(
        ...
        category: HexpediaCategory.seasons,
        titleTr: '12 Hayvanlı Göksel Takvim & Kehanet Sinerjisi',
        titleEn: '12-Year Celestial Calendar & Omen Synergy',
        summaryTr: 'Her yeni yılda göklerden inen 12 kadim hayvan ruhunun küresel lütufları ve göç koordinasyonu.',
        summaryEn: 'Each game year bestows a global omen from the 12 celestial animal spirits with tactical migration synergies.',
        contentTr: 'Her 4 mevsim tamamlandığında (240 saniye) yeni bir Göksel Yıl başlar ve tüm kağanlığa devasa küresel çarpanlar iner:\n\n• Pars Yılı (Kereste & İnşaat): Ormanlar coşar, kereste üretimi 2 katına (2.0x) çıkar. Şato yükseltmeleri ve kışlık yakıt ambarı bu yılda doldurulmalıdır.\n• Tavşan Yılı (Göç & Fetih): Fetih ve genişleme maliyetleri %25 ucuzlar. Büyük Göçün hemen ardından Tavşan Yılında harita rekor hızla fethedilir.\n• Ejder Yılı (Maden & Metalurji): Madenler zengin filiz döker (1.8x Demir). Şam Çeliği dökümhaneleri bu yılda tam kapasite çalıştırılmalıdır.\n• At Yılı (Lojistik & Kervan): İşçiler ve kervanlar %50 daha hızlı koşar. Fabrika ve ambar arasındaki tıkanıklıklar anında erir.\n• Sıçan Yılı (Refah & Ambar): Tahıl üretimi 1.4x katlanır, ambar kapasitesi genişler.\n• Sığır Yılı (Kış Direnci): Zud fırtınalarına karşı doğal kalkan sağlar, taş ocakları coşar.\n• Koyun Yılı (Bozkır Sürüsü): Sürü bereketi +%60 kımız ve iaşe sağlar, bilgelik üretimi hızlanır.\n• Yılan Yılı (Kadim Simya): Şifacılar iksir üretir, pazar takas kurları en yüksek seviyeye ulaşır.',
        contentEn: 'Every completed 4-season cycle (240s) ushers in a new Celestial Year offering huge global multipliers:\n\n• Tiger Year: Wood production doubles (2.0x). Stockpile wood for Castle upgrades and winter warmth.\n• Hare Year: Conquest costs drop by 25%. Ideal for rapid early expansion right after a Great Migration.\n• Dragon Year: Mines yield 1.8x iron. Peak window for Damascus Steel forging.\n• Horse Year: Workers and caravans move 50% faster, clearing logistics bottlenecks.\n• Rat Year: Grain output boosts by 1.4x, maximizing granary stores.\n• Ox Year: Grants natural resilience against Zud frosts and stone boosts.\n• Sheep Year: Boosts kumis and food by +60%.\n• Snake Year: Optimal market trade exchange rates.',
        icon: Icons.brightness_auto,
        iconColor: Color(0xFFFDE047),
        badgeText: '12 YIL DÖNGÜSÜ',
        stats: {
          'Döngü Süresi': 'Her 1 Oyun Yılı (240 Saniye)',
          'Pars Yılı': '2.0x Odun Üretimi (Şato Geliştirme)',
          'Tavşan Yılı': '-%25 Karo Fetih Maliyeti (Göç Sonrası)',
          'Ejder Yılı': '1.8x Demir Üretimi (Şam Çeliği)',
          'At Yılı': '+%50 İşçi & Kervan Hızı',
        },
        stepGuideTr: [
          'Ekranın üst barındaki Göksel Rozete bakarak o an hangi hayvan yılında olduğunuzu kontrol edin.',
          'Gelen hayvan lütfuna göre üretimi koordine edin (Örn: Pars yılında odun, Ejder yılında demir üretimi).',
          'Tavşan Yılı geldiğinde yeni karoları fetheterek haritanızı asgari maliyetle genişletin.',
        ],
        stepGuideEn: [
          'Check the active celestial omen badge on the top HUD to view the current animal year.',
          'Coordinate production around the active blessing (e.g., wood in Tiger year, iron in Dragon year).',
          'Conquer frontier hexes during the Hare Year for maximum resource efficiency.',
        ],
        tipsTr: [
          'GÖKSEL GÖÇ TAKTİĞİ: Büyük Göçü Tavşan Yılına denk getirdiğinizde yeni diyarda 12 karoyu sadece 2-3 dakikada fethedersiniz.',
          'Pars Yılında harcadığınız odun miktarını kısıp Kağan Otağını bir sonraki seviyeye yükseltin.',
          'Ejder Yılında dökülen Şam Çelikleri ile Kültürel Zafer şartlarını hızla tamamlayın.',
        ],
        tipsEn: [
          'CELESTIAL MIGRATION TACTIC: Time migrations with the Hare Year to conquer 12 hexes in 2-3 minutes at 25% discount.',
          'Save wood during Tiger Year to fuel consecutive Castle upgrades.',
          'Maximize Damascus Steel smelting during Dragon Year to rush Cultural Victory requirements.',
        ],
        tags: ['kehanet', 'göksel', 'takvim', '12hayvan', 'pars', 'at', 'ejder', 'tavşan', 'omen', 'celestial'],
      ),
      ...
      const HexpediaEntry(
        ...
        summaryTr: 'Diyarı terk edip kümülatif Tamgalar, Taçlar ve ata mirası anıtlarıyla yeni topraklara göç etme.',
        summaryEn: 'Migrate to new realms, retaining cumulative Tamgas, Crown tokens, and Ancestral Kurgan relic echoes.',
        contentTr: 'Kağanlığınız yeterince büyüdüğünde (en az 12 fethedilmiş karo ve Seviye 5 Kağan Otağı), sağdaki Harita butonuna basarak "Büyük Göç" başlatabilirsiniz. Göç ettiğinizde topraklar ve hammaddeler sıfırlanır ancak yerine kalıcı miraslar kazanılır:\n\n1. Atalar Tamgası (Kalıcı Kut Çarpanı):\n• İlk 50 Tamgaya kadar: Her Tamga tüm krallık üretimine net +%4 kalıcı çarpan verir.\n• 50-100 Tamga: Logaritmik büyüme ile istikrarlı artar.\n• 100+ Tamga (Mega Patlama): Tamga sayısı 100 barajını aştığında oyunun formülü sıçrama yaparak devasa 11.0x Kut Çarpanını tetikler!\n\n2. Şan & Kut Taçları (Crowns):\n• Sahip olunan her 5 karo = 1 Taç\n• Kağan Otağının her 2 seviyesi = 1 Taç\n• İnşa edilen her 15 bina kademesi = 1 Taç\n• Kademeli ambar refahı = 1-4 Taç\n• Taçlar Töre Meclisindeki ferman ve doktrinleri kalıcı olarak açmak için harcanır.\n\n3. Ata Kurganları (Ancestral Kurgans):\nEski diyardaki en yüksek seviyeli binalarınız yeni haritada kadim kurgan höyükleri olarak belirir; keşfedildiklerinde devasa kalıcı aura üretir.',
        contentEn: 'Once reaching 12+ hexes and Castle Level 5, initiate the Great Migration. You earn permanent Tamga tokens (+4% global Kut multiplier each, jumping to 11.0x at 100+ Tamgas), Crowns for doctrine unlocks, and leave behind Ancestral Kurgans.',
        icon: Icons.flight_takeoff,
        iconColor: Color(0xFF818CF8),
        badgeText: 'PRESTİJ MOTORU',
        stats: {
          'Asgari Eşik': '12 Fethedilmiş Karo & Sv.5 Otağ',
          'Tamga Formülü': '(Sahip Olunan Karo + Tapınak x 5) / 2',
          'Taç Formülü': '(Karo/5) + (Otağ/2) + (Binalar/15) + Refah',
          'Kut Zirvesi': '100+ Tamgada 11.0x Mega Çarpan',
        },
        stepGuideTr: [
          'Sağdaki mor Diyar Seçimi butonuna dokunun.',
          'Kazanacağınız Tamga miktarını, Taç ödüllerini ve Kurgan mirasını inceleyin.',
          'GÖÇÜ BAŞLAT butonuna basarak yeni topraklarda kat kat daha güçlü bir başlangıç yapın.',
        ],
        stepGuideEn: [
          'Tap the purple Realm Migration button on the right toolbar.',
          'Review your earned Tamga count, Crown rewards, and Kurgan relics.',
          'Tap INITIATE MIGRATION to start fresh with permanent prestige multipliers.',
        ],
        tipsTr: [
          'ÜSSEL DUVAR KURALI: 20-25 karoyu aştığınızda fetih maliyeti 1.6 üssüyle milyonlara fırlar. Asla tek haritada inat etmeyin; fetih tıkandığı an derhal Büyük Göç yapın.',
          'Her Büyük Göç, toplam göç sayınıza bağlı olarak ek +%5 kalıcı çarpan kazandırır.',
        ],
        tipsEn: [
          'EXPONENTIAL WALL: Conquest costs scale at 1.6^N. When costs spike into millions, migrate immediately instead of stalling.',
          'Each migration adds an extra +5% permanent multiplier based on total migrations completed.',
        ],
        tags: ['göç', 'tamga', 'prestij', 'taç', 'kurgan', 'ata', 'kut', 'migration', 'prestige'],
      ),

      const HexpediaEntry(
        id: 'migration_optimal_timing',
        category: HexpediaCategory.migration,
        titleTr: 'Büyük Göç Stratejik Zamanlaması & 5 Altın Eşik',
        titleEn: 'Strategic Migration Timing & 5 Golden Thresholds',
        summaryTr: 'Tüm çağları ve Kozmik Zirveyi 9-11 saatte tamamlamanızı sağlayan matematiksel optimal göç takvimi.',
        summaryEn: 'Mathematical optimal prestige schedule to clear all ages and technologies within 9-11 hours.',
        contentTr: 'Bozkır simülasyonları, körü körüne tek haritada kalmanın oyunu 50+ saat uzattığını; doğru zamanlanmış 5 Altın Eşik (5 Büyük Göç) ile ise tüm oyunun 9-11 saatte tamamlanabildiğini kanıtlamıştır:\n\n1. EŞİK: İlk Sıçrama (20-25. Dakika)\n• Şart: Şato Sv. 5-6 | 12-14 Karo\n• Kazanç: +6-7 Tamga, +4-5 Taç (Kut: 1.25x)\n• Hedef: İlk Töre fermanlarını açmak ve üretimi %25 hızlandırmak.\n\n2. EŞİK: Erken Zanaat & Kervan (1. Saat - 1s 15dk)\n• Şart: Şato Sv. 10-12 | 18-20 Karo\n• Kazanç: +14-16 Tamga, +8-10 Taç (Kümülatif: ~22 Tamga, 1.9x Kut)\n• Hedef: Meyve Bahçesi ve Kervan doktrinlerini kalıcı kılmak.\n\n3. EŞİK: Demir & Ağır Sanayi (2.5 - 3. Saat)\n• Şart: Şato Sv. 20 | 25-28 Karo | Madenler & Fırınlar aktif\n• Kazanç: +20-25 Tamga, +18-20 Taç (Kümülatif: ~45 Tamga, 2.8x Kut)\n• Hedef: 25. karonun üssel duvarından kurtulup madenleri katlamak.\n\n4. EŞİK: Bozkır İmparatorluğu (5. - 6. Saat)\n• Şart: Şato Sv. 30-35 | 35-42 Karo | Kımız Yurtları & Keçe Çadırları\n• Kazanç: +35-45 Tamga, +35-40 Taç (Kümülatif: ~85 Tamga, 5.0x Kut)\n• Hedef: Efsanevi biyomları tek vuruşta fethetmek.\n\n5. EŞİK: Kozmik Zirveye Hücum (8. - 9. Saat)\n• Şart: Şato Sv. 40+ | 50+ Karo | Şam Çeliği dökümhaneleri\n• Kazanç: 100+ Tamga barajını aşarak 11.0x MEGA KUT PATLAMASINI tetiklemek.\n• Sonuç: Son koşuda Şato 50 Kozmik Zirve yapıları 1-2 saatte tamamlanır.',
        contentEn: 'Progression simulations prove that lingering on one map extends playtime beyond 50+ hours, while 5 structured migrations clear the entire game in 9-11 hours:\n\n1. Threshold (20-25 min): Castle Lvl 5-6, 12-14 hexes -> +6 Tamga (1.25x Kut).\n2. Threshold (1h 15m): Castle Lvl 10-12, 18-20 hexes -> +15 Tamga (1.9x Kut).\n3. Threshold (2.5-3h): Castle Lvl 20, 25-28 hexes -> +25 Tamga (2.8x Kut).\n4. Threshold (5-6h): Castle Lvl 30-35, 35-42 hexes -> +40 Tamga (5.0x Kut).\n5. Threshold (8-9h): Castle Lvl 40+, 50+ hexes -> Surpass 100 Tamgas to trigger the 11.0x MEGA KUT MULTIPLIER.',
        icon: Icons.timer,
        iconColor: Color(0xFFF59E0B),
        badgeText: 'TAKTİK REHBER',
        stats: {
          'Optimal Göç Sayısı': '5 Planlı Büyük Göç',
          'Tüm Teknolojiler': '35 - 45 Dakika (Tek Haritada)',
          'Tüm Çağlar (Sv.50)': '9 - 11 Saat (5 Göç İle)',
          'Kut Çarpanı Zirvesi': '100+ Tamga ile 11.0x Hız',
        },
        stepGuideTr: [
          'Karo fetih maliyeti 10.000 gıdayı aştığında üretimin yavaşlamasını beklemeyin.',
          'Kağan Otağı seviyenizin 5, 10, 20, 30 ve 40 basamaklarına ulaştığını doğrulayın.',
          'Büyük Göç başlatıp kazandığınız Tamgalarla bir sonraki koşuyu 2-3 kat daha hızlı tamamlayın.',
        ],
        stepGuideEn: [
          'Do not wait for production to grind to a halt when conquest costs exceed 10,000 food.',
          'Check that your Castle has reached milestones 5, 10, 20, 30, or 40.',
          'Trigger Great Migration to accelerate your next run by 2-3x.',
        ],
        tipsTr: [
          '1. Göçten sonra ilk 5 seviyeyi geçmek sadece 2-3 dakikanızı alacaktır; sıfırlanmaktan asla korkmayın.',
          'Göç etmeden önce ambarınızdaki kaynakları harcamayın; ambar refahı size +1 ila +4 ekstra Taç kazandırır.',
        ],
        tipsEn: [
          'Reaching Level 5 after your 1st migration takes only 2-3 minutes; never fear resetting.',
          'Do not spend stockpile resources right before migrating; high stores grant +1 to +4 extra Crowns.',
        ],
        tags: ['zamanlama', 'eşik', 'strateji', 'plan', 'hız', 'göç', 'timing', 'threshold', 'guide'],
      ),
