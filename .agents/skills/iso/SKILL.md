...
- **`prompt-optimizer`** bu kuralları sentezler; Antigravity mimarisine (Flutter, Flame, Riverpod, TDD vb.) tam uyumlu, adım adım icra edilebilir **Nihai Operasyonel Prompt** üretir.
